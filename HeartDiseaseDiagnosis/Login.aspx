<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HealthRecordSystem.Login" %>
		...
		<td colspan="2" style="padding-top:8px; padding-left:4px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><div class="inner_copy"></div>
				...
				<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50%" class="heafing3">Expert Login</td>
								</tr>
							<tr>
								<td class="text"><strong></strong><br />
                                <asp:Login ID="Login1" runat="server" PasswordRecoveryText="Forgot Password" 
            PasswordRecoveryUrl="RetrievePassword.aspx" DestinationPageUrl="Default.aspx">
        </asp:Login>
